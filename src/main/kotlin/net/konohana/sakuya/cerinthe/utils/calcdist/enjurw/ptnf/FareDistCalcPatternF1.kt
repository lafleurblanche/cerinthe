 ...
 * @return 営業キロ, 運賃計算キロ
 */
fun faredistCalcPatternF1(fromDist: Double, toDist: Double): Pair<Double, Int> {
    val dist =
        fromDist +
        RouteDistanceEnjuRWConst.ROUTE_DISTANCE_ENJU_RW06_PTN_CMN04 +
