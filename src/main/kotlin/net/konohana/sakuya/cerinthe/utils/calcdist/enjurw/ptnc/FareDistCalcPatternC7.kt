 ...
 * @return 営業キロ, 運賃計算キロ
 */
fun faredistCalcPatternC7(fromDist: Double, toDist: Double): Pair<Double, Int> {
    val dist = abs(fromDist - RouteDistanceEnjuRWConst.ROUTE_DISTANCE_ENJU_PTN_C7) + toDist
