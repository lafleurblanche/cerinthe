...
class FareDistCalcRuleConst {
    companion object {
        ...
        /** 経路情報計算ルール(中間駅(荍谷)) */
        const val FAREDIST_CALCRULE_PATTERN_C15 = "C15"
        ...
        /** 経路情報計算ルール(中間経路(苆谷～槐谷)) */
        const val FAREDIST_CALCRULE_PATTERN_D5A = "D5A"
        ...
        /** 経路情報計算ルール(中間経路(茄谷～槐谷)) */
        const val FAREDIST_CALCRULE_PATTERN_D11A = "D11A"
        ...
        /** 経路情報計算ルール(中間経路(笥谷～槐谷)) */
        const val FAREDIST_CALCRULE_PATTERN_D16A = "D16A"
        ...
        /** 経路情報計算ルール(中間経路(筏谷～槐谷)) */
        const val FAREDIST_CALCRULE_PATTERN_D20A = "D20A"
        ...
        /** 経路情報計算ルール(中間経路(筮谷～槐谷)) */
        const val FAREDIST_CALCRULE_PATTERN_D23A = "D23A"
        ...
        /** 経路情報計算ルール(中間経路(槐谷～卯塚)) */
        const val FAREDIST_CALCRULE_PATTERN_D51 = "D52"
        /** 経路情報計算ルール(中間経路(槐谷～瑞堂)) */
        const val FAREDIST_CALCRULE_PATTERN_D52 = "D52"
        ...
        /** 経路情報計算ルール(中間経路(槐谷～卯塚, 卯塚～筁谷)) */
        const val FAREDIST_CALCRULE_PATTERN_E51A = "E51A"
        ...
        /** 経路情報計算ルール(中間経路(槐谷～卯塚, 卯塚～筥谷)) */
        const val FAREDIST_CALCRULE_PATTERN_E53A = "E53A"
        ...
        /** 経路情報計算ルール(中間経路(槐谷～卯塚, 卯塚～笒谷)) */
        const val FAREDIST_CALCRULE_PATTERN_E55A = "E55A"
        ...
        /** 経路情報計算ルール(中間経路(槐谷～卯塚, 卯塚～箬谷)) */
        const val FAREDIST_CALCRULE_PATTERN_E57A = "E57A"
        ...
        /** 経路情報計算ルール(中間経路(荍谷～瑞堂, 瑞堂～卯塚)) */
        const val FAREDIST_CALCRULE_PATTERN_E64 = "E64"
        /** 経路情報計算ルール(中間経路(荍谷～瑞堂～卯塚~槐谷線内着)) */
        const val FAREDIST_CALCRULE_PATTERN_E64A = "E64A"
        ...
        /** 経路情報計算ルール(中間経路(槐谷～卯塚～瑞堂～苕谷)) */
        const val FAREDIST_CALCRULE_PATTERN_F25A = "F25A"
        /** 経路情報計算ルール(中間経路(扆谷～瑞堂～卯塚～槐谷)) */
        const val FAREDIST_CALCRULE_PATTERN_F26 = "F26"
        /** 経路情報計算ルール(中間経路(槐谷～卯塚～瑞堂～扆谷)) */
        const val FAREDIST_CALCRULE_PATTERN_F26A = "F26A"
        /** 経路情報計算ルール(中間経路(珩谷～瑞堂～卯塚～槐谷)) */
        const val FAREDIST_CALCRULE_PATTERN_F27 = "F27"
        /** 経路情報計算ルール(中間経路(槐谷～卯塚～瑞堂～珩谷)) */
        const val FAREDIST_CALCRULE_PATTERN_F27A = "F27A"
        /** 経路情報計算ルール(中間経路(玿谷～瑞堂～卯塚～槐谷)) */
        const val FAREDIST_CALCRULE_PATTERN_F28 = "F28"
        /** 経路情報計算ルール(中間経路(槐谷～卯塚～瑞堂～玿谷)) */
        const val FAREDIST_CALCRULE_PATTERN_F28A = "F28A"
        /** 経路情報計算ルール(中間経路(珮谷～瑞堂～卯塚～槐谷)) */
        const val FAREDIST_CALCRULE_PATTERN_F29 = "F29"
        /** 経路情報計算ルール(中間経路(槐谷～卯塚～瑞堂～珮谷)) */
        const val FAREDIST_CALCRULE_PATTERN_F29A = "F29A"
        /** 経路情報計算ルール(中間経路(荍谷～瑞堂～卯塚～槐谷)) */
        const val FAREDIST_CALCRULE_PATTERN_F30 = "F30"
        /** 経路情報計算ルール(中間経路(槐谷～卯塚～瑞堂～荍谷)) */
        const val FAREDIST_CALCRULE_PATTERN_F30A = "F30A"
    }
}
